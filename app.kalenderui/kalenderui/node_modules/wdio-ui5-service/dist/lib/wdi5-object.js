...
var executeObjectMethod_1 = require("../../client-side-js/executeObjectMethod");
...
var WDI5Object = /** @class */ (function () {
    function WDI5Object(uuid, aProtoFunctions, object) {
        ...
        if (aProtoFunctions) {
            ...
            Logger.warn("[WANING] creating object: ".concat(uuid, " without functions"));
        }
        if (object) {
            ...
            Logger.warn("[WANING] creating object: ".concat(uuid, " without properties"));
        }
    }
    ...
    WDI5Object.prototype._excuteObjectMethod = function (methodName, uuid) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, executeObjectMethod_1.clientSide_executeObjectMethod)(uuid, methodName, args)];
                    case 1:
                        result = (_a.sent());
                        // create logging
