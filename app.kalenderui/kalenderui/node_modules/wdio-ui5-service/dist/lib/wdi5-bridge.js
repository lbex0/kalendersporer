...
exports._addWdi5Commands = exports.authenticate = exports.checkForUI5Page = exports.injectUI5 = exports.start = exports.setup = void 0;
...
var wdi5_control_1 = require("./wdi5-control");
var wdi5_fe_1 = require("./wdi5-fe");
var injectTools_1 = require("../../client-side-js/injectTools");
var injectUI5_1 = require("../../client-side-js/injectUI5");
var getSelectorForElement_1 = require("../../client-side-js/getSelectorForElement");
var _checkForUI5Ready_1 = require("../../client-side-js/_checkForUI5Ready");
var getObject_1 = require("../../client-side-js/getObject");
var getUI5Version_1 = require("../../client-side-js/getUI5Version");
var _navTo_1 = require("../../client-side-js/_navTo");
var allControls_1 = require("../../client-side-js/allControls");
var Logger_1 = require("./Logger");
var wdi5_object_1 = require("./wdi5-object");
var BTPAuthenticator_1 = __importDefault(require("./authentication/BTPAuthenticator"));
var BasicAuthenticator_1 = __importDefault(require("./authentication/BasicAuthenticator"));
var CustomAuthenticator_1 = __importDefault(require("./authentication/CustomAuthenticator"));
var Office365Authenticator_1 = __importDefault(require("./authentication/Office365Authenticator"));
...
function setup(config) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            if (browser instanceof multiremote_1.MultiRemoteDriver) {
                ;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2:
                    Logger.info("open url: ".concat(browser.config.baseUrl));
                    return [4 /*yield*/, browser.url(browser.config.baseUrl)];
                case 3:
                    _a.sent();
                    _a.label = 4;
...
function initBrowser(browserInstance) {
    ...
    if (!browserInstance.fe) {
        ;
        browserInstance.fe = wdi5_fe_1.WDI5FE;
    }
    _setupComplete = true;
}
...
function injectUI5(config, browserInstance) {
    return __awaiter(this, void 0, void 0, function () {
        var waitForUI5Timeout, result, version, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    waitForUI5Timeout = config.wdi5.waitForUI5Timeout || 15000;
                    result = true;
                    return [4 /*yield*/, browserInstance.getUI5Version()];
                case 1:
                    version = _b.sent();
                    return [4 /*yield*/, checkUI5Version(version)];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, injectTools_1.clientSide_injectTools)(browserInstance)]; // helpers for wdi5 browser scope
                case 3:
                    _b.sent(); // helpers for wdi5 browser scope
                    _a = result;
                    if (!_a) return [3 /*break*/, 5];
                    return [4 /*yield*/, (0, injectUI5_1.clientSide_injectUI5)(config, waitForUI5Timeout, browserInstance)];
                case 4:
                    _a = (_b.sent());
                    _b.label = 5;
                case 5:
            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case "BasicAuth": return [3 /*break*/, 3];
                        case "Office365": return [3 /*break*/, 5];
                        case "custom": return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 9];
                case 1: return [4 /*yield*/, new BTPAuthenticator_1["default"](options, browserInstanceName).login()];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 10];
                case 3: return [4 /*yield*/, new BasicAuthenticator_1["default"](browserInstanceName).login()];
                case 4:
                    _b.sent();
                    return [3 /*break*/, 10];
                case 5: return [4 /*yield*/, new Office365Authenticator_1["default"](options, browserInstanceName).login()];
                case 6:
                    _b.sent();
                    return [3 /*break*/, 10];
                case 7: return [4 /*yield*/, new CustomAuthenticator_1["default"](options, browserInstanceName).login()];
                case 8:
                    _b.sent();
                    _b.label = 9;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            (0, marky_1.mark)("retrieveSingleControl");
                            return [4 /*yield*/, new wdi5_control_1.WDI5Control({ browserInstance: browserInstance }).init(wdi5Selector, wdi5Selector.forceSelect)];
                        case 1:
                            wdi5Control = _b.sent();
                            e = (0, marky_1.stop)("retrieveSingleControl");
            ...
            browser.addCommand("asObject", function (_uuid) { return __awaiter(_this, void 0, void 0, function () {
                var _result, uuid, status, aProtoFunctions, className, object, wdiOjject;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, getObject_1.clientSide_getObject)(_uuid)];
                        case 1:
                            _result = (_a.sent());
                            ...
                            if (status === 0) {
                                wdiOjject = new wdi5_object_1.WDI5Object(uuid, aProtoFunctions, object);
                                return [2 /*return*/, wdiOjject];
                            }
            ...
            browserInstance.addCommand("getSelectorForElement", function (oOptions) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, getSelectorForElement_1.clientSide_getSelectorForElement)(oOptions, browserInstance)];
                        case 1:
                            result = (_a.sent());
                            if (result.status === 1) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, getUI5Version_1.clientSide_getUI5Version)(browserInstance)];
                        case 1:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!browserInstance.config.wdi5.url) return [3 /*break*/, 13];
                            _a = browserInstance.config.wdi5["url"];
 ...
 */
function _allControls(controlSelector, browserInstance) {
    var _a, e_1, _b, _c;
    var _d, _e;
    if (controlSelector === void 0) { controlSelector = this._controlSelector; }
    if (browserInstance === void 0) { browserInstance = browser; }
    return __awaiter(this, void 0, void 0, function () {
        var response, retrievedElements, resultWDi5Elements, _f, retrievedElements_1, retrievedElements_1_1, cControl, oOptions, e_1_1;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    if (typeof ((_d = controlSelector.selector.properties) === null || _d === void 0 ? void 0 : _d.text) === "object" &&
                        ((_e = controlSelector.selector.properties) === null || _e === void 0 ? void 0 : _e.text) instanceof RegExp) {
                        // make it a string for serializing into browser-scope and
                        // further processing there
                        controlSelector.selector.properties.text = controlSelector.selector.properties.text.toString();
                    }
                    return [4 /*yield*/, (0, allControls_1.clientSide_allControls)(controlSelector, browserInstance)];
                case 1:
                    response = _g.sent();
                ...
                case 2:
                    ...
                    _f = true, retrievedElements_1 = __asyncValues(retrievedElements);
                    _g.label = 3;
                case 3: return [4 /*yield*/, retrievedElements_1.next()];
                case 4:
                    if (!(retrievedElements_1_1 = _g.sent(), _a = retrievedElements_1_1.done, !_a)) return [3 /*break*/, 6];
                    _c = retrievedElements_1_1.value;
                    _f = false;
                    try {
                        cControl = _c;
                        oOptions = {
                        ...
                        resultWDi5Elements.push(new wdi5_control_1.WDI5Control(oOptions));
                    }
                    finally {
                        _f = true;
                    }
                ...
                case 8:
                    ...
                    if (!(!_f && !_a && (_b = retrievedElements_1["return"]))) return [3 /*break*/, 10];
                    return [4 /*yield*/, _b.call(retrievedElements_1)];
                case 9:
                    _g.sent();
                    _g.label = 10;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ready = false;
                    if (!_isInitialized) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, _checkForUI5Ready_1.clientSide__checkForUI5Ready)(browserInstance)];
                case 1: 
...
function _navTo(sComponentId, sName, oParameters, oComponentTargetInfo, bReplace, browserInstance) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, _navTo_1.clientSide__navTo)(sComponentId, sName, oParameters, oComponentTargetInfo, bReplace, browserInstance)];
                case 1:
                    result = (_a.sent());
                    if (result.status === 1) {
