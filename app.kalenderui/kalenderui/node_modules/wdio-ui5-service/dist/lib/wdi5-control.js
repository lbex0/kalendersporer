...
exports.WDI5Control = void 0;
var util = __importStar(require("util"));
var constants_1 = require("webdriverio/build/constants");
var getControl_1 = require("../../client-side-js/getControl");
var interactWithControl_1 = require("../../client-side-js/interactWithControl");
var executeControlMethod_1 = require("../../client-side-js/executeControlMethod");
var _getAggregation_1 = require("../../client-side-js/_getAggregation");
var fireEvent_1 = require("../../client-side-js/fireEvent");
var Logger_1 = require("./Logger");
var wdioApi_1 = require("./wdioApi");
...
var WDI5Control = /** @class */ (function () {
    function WDI5Control(oOptions) {
        ...
        this._specificInteractionControls = [
            "sap.m.ComboBox",
            "sap.m.SearchField",
            "sap.m.Input",
            "sap.m.List",
    ...
    WDI5Control.prototype.init = function (controlSelector, forceSelect) {
        var _a, _b;
    ...
    WDI5Control.prototype.press = function () {
        return __awaiter(this, void 0, void 0, function () {
            var className, controlSelector, specificInteractionControls, logging, _controlInfo, oOptions, error_4, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!util.types.isProxy(this._domId)) return [3 /*break*/, 5];
                        return [4 /*yield*/, Promise.resolve(this._specificInteractionControls)];
                    case 1:
                        specificInteractionControls = _a.sent();
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6:
                        if (!(specificInteractionControls.includes(className) &&
                            controlSelector.selector.interaction.match(/press/i))) return [3 /*break*/, 11];
                        if (logging) {
     ...
     */
    WDI5Control.prototype.fireEvent = function (eventName, oOptions, webElement) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fireEvent_1.clientSide_fireEvent)(webElement, eventName, oOptions, this._browserInstance)];
                    case 1:
                        result = (_a.sent());
                        if (this._logging) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, (0, interactWithControl_1.clientSide_interactWithControl)(oOptions, browserInstance)];
                    case 8:
                        result = (_b.sent());
                        if (logging) {
     ...
     * @returns
     */
    WDI5Control.prototype._renewWebElement = function (id) {
     ...
     */
    WDI5Control.prototype._executeControlMethod = function (methodName, webElement) {
        if (webElement === void 0) { webElement = this._webElement; }
        var args = [];
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _a, error_6, result, _b, wdioElement;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, (0, executeControlMethod_1.clientSide_executeControlMethod)(webElement, methodName, this._browserInstance, args, 
                    ...
                    case 12: 
                    // enhance with uuid
                    return [2 /*return*/, new wdi5_object_1.WDI5Object(result.uuid, result.aProtoFunctions, result.object)];
                    case 13:
                        if (this._logging) {
     ...
     * @return {any}
     */
    WDI5Control.prototype._getAggregation = function (aggregationName, webElement) {
        if (webElement === void 0) { webElement = this._webElement; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, (0, _getAggregation_1.clientSide_getAggregation)(webElement, aggregationName, this._browserInstance)];
                    case 11:
                        result = (_c.sent());
                        if (_logging) {
     ...
     */
    WDI5Control.prototype._renewWebElementReference = function (isRefresh) {
     ...
     */
    WDI5Control.prototype.renewWebElementReference = function (asRefresh) {
     ...
     */
    WDI5Control.prototype._getControl = function (controlSelector) {
        var _a, _b;
        if (controlSelector === void 0) { controlSelector = this._controlSelector; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, getControl_1.clientSide_getControl)(controlSelector, this._browserInstance)];
                    case 1:
                        _result = (_c.sent());
                        if (!(_result.status === 0 && !_result.domElement[constants_1.ELEMENT_KEY])) return [3 /*break*/, 3];
                    ...
                    case 3:
                        ...
                        if (status === 0 && id) {
                            ...
                            this._generatedWdioMethods = wdioApi_1.wdioApi;
                            // add metadata
