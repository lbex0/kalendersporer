...
exports.wdi5 = void 0;
var Authenticator_1 = __importDefault(require("./lib/authentication/Authenticator"));
...
var wdi5 = /** @class */ (function () {
    ...
    wdi5.getLogger = function (sPrefix) {
        ...
        return Logger_1.Logger.getInstance(sPrefix);
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!browserInstanceName) {
                    return [2 /*return*/, new Authenticator_1["default"]().getIsLoggedIn()];
                }
                if (!authenticatorInstances[browserInstanceName]) {
                    authenticatorInstance = new Authenticator_1["default"](browserInstanceName);
    ...
    wdi5.goTo = function (byWhat, oRoute, browserInstance) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (oRoute) {
                            Logger_1.Logger.getInstance().warn("deprecated signature: please use single parameter as nav target: wdi5.goTo(target)");
                            byWhat = oRoute;
                        }
                        if (!(typeof byWhat === "string")) return [3 /*break*/, 2];
                        Logger_1.Logger.getInstance().info("Navigating via string hash: ".concat(byWhat));
                    ...
                    case 2:
                        ...
                        Logger_1.Logger.getInstance().info("Navigating via object w/ property sHash: ".concat(JSON.stringify(byWhat)));
                        return [4 /*yield*/, browserInstance.goTo(byWhat)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 4:
                        ...
                        Logger_1.Logger.getInstance().info("Navigating via UI5 router object: ".concat(JSON.stringify(byWhat)));
                        return [4 /*yield*/, browserInstance.goTo({ oRoute: byWhat })];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 6:
                        Logger_1.Logger.getInstance().info("Navigating via generic object: ".concat(JSON.stringify(byWhat)));
